...
def find_date_in_current_week(day_of_week):
    ...
    days_until_target_day = (day_of_week - today.weekday() - 2)
    print (days_until_target_day)
    if days_until_target_day > 0:
        days_until_target_day = days_until_target_day % 7
        target_date = today + timedelta(days=days_until_target_day)
    if days_until_target_day <= 0:
        days_until_target_day = -days_until_target_day
        days_until_target_day = days_until_target_day % 7
        target_date = today - timedelta(days=days_until_target_day)
    # Calculate the date of the last occurrence of the desired day of the week in the current week
